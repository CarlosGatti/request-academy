...
export type DataAuditProfilesQuery = { dataAuditProfiles: { auditRunId: number | null, total: number, items: Array<{ id: number, displayName: string | null, avatarUrl: string | null, avatarPath: string | null, agentType: string | null, agencyName: string | null, yearsInBusiness: number | null, yearsInArea: number | null, contractsCompleted: number | null, cities: unknown, clientSpecializations: unknown, isVerified: boolean | null, isProfileComplete: boolean | null, hasEmail: boolean, hasPhone: boolean, hasDocumentReferences: boolean, documentReferenceCount: number, findingCount: number, highestSeverity: string | null }> } };
